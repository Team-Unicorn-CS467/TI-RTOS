...
/* --> Idle_blink */
extern xdc_Void Idle_blink(xdc_Void);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[7994];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/kevine/workspace_v12/empty_EK_TM4C123GXL_TI/Debug/configPkg/package/cfg/empty_pem4f");
...
const __T1_ti_sysbios_knl_Idle_funcList ti_sysbios_knl_Idle_funcList__A[3] = {
    ((xdc_Void(*)(xdc_Void))((xdc_Fxn)Idle_blink)),  /* [0] */
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1f3a;
